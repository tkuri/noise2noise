...
from generator import NoisyImageGenerator, NoisyImageGeneratorIn2, ValGenerator, ValGeneratorIn2
...
def get_args():
    ...
    parser.add_argument("--image_dir_2", type=str, default="",
                        help="train image dir2")
    parser.add_argument("--test_dir", type=str, required=True,
                        help="test image dir")
    parser.add_argument("--test_dir_2", type=str, default="",
                        help="train image dir2")
...
#     parser.add_argument("--val_noise_model", type=str, default="gaussian,25,25",
    parser.add_argument("--val_noise_model", type=str, default="impulse,70,70",
...
#                                     image_size=image_size)
    generator = NoisyImageGeneratorIn2(image_dir, image_dir_2, source_noise_model, target_noise_model, batch_size=batch_size,
                                    image_size=image_size)
#     val_generator = ValGenerator(test_dir, val_noise_model)
    val_generator = ValGeneratorIn2(test_dir, test_dir_2, val_noise_model)
